import ZlockFeature from "./ZPDSFeature";
import zlockLogo from "../../../../public/Products/Zpds.png";
import ZlockGuide from "./ZPDSGuide";
      ...
      <div className="md:min-h-screen md:mb-0 mb-10 ">
        <div className="relative h-full overflow-hidden">
          ...
          <h1
            ...
            ref={textRef}
          >
            <img src={zlockLogo} alt="" className="h-14 w-62 mb-2.5" />Z PDS |
