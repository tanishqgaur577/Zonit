import zlockLogo from "../../../../public/Products/Zindu.png";
import React, { useRef, useEffect } from "react";
import HeroImage from "../../../../public/Products/heroImage.png";
import FirstSection from "./FirstSection";
import ZlockFeature from "./ZATS-INDUFeature";
import SecondSection from "./SecondSection";
import ZlockGuide from "./ZATS-INDUGuide";
      ...
      <div className="md:min-h-screen md:mb-0 mb-10 ">
        <div className="relative h-full overflow-hidden">
          ...
          <h1
            ...
            ref={textRef}
          >
            <img src={zlockLogo} alt="" className="h-14 w-62 mb-2.5" />Z
            Industries | Secure Your Data Center Power
          </h1>
        </div>
      </div>
      <FirstSection />
