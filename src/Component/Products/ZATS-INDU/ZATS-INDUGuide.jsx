...
const ZlockGuide = () => {
  return (
    <div className="relative min-h-[80vh] text-black flex justify-center  py-7 flex-col  items-center w-full bg-white">
      <h1 className="text-3xl font-semibold text-center mb-8">
        Download ZLock Product Sheets
      </h1>
      <div className="h-[48vh] md:block flex flex-col items-center  justify-center   py-6 md:px-24 px-8 relative md:w-[50%] w-[90%] shadow-2xl">
        ...
        <div className=" gap-2 flex  flex-col mt-4">
          <div className="flex justify-start gap-5 items-center">
            <img src={docs} className="lg:h-14 h-8 w-8 lg:w-14" alt="" />
