...
const ZlockGuide = () => {
  return (
    <div className="relative min-h-[80vh] text-black flex justify-around py-7 flex-col  items-center w-full bg-white">
      <h1 className="text-3xl font-semibold">Download ZLock Product Sheets</h1>
      <div className="h-[48vh] py-6 px-24 relative md:w-[50%] shadow-2xl">
