...
import zlockLogo from "../../../../public/Products/Zai.png";
import FirstSection from "./FirstSection";
import ZlockFeature from "./ZATS-AIFeature";
import SecondSection from "./SecondSection";
import ZlockGuide from "./ZATS-AIGuide";
      ...
      <div className="md:min-h-screen md:mb-0 mb-10 ">
        <div className="relative h-full overflow-hidden">
          ...
          <h1
            ...
            ref={textRef}
          >
            <img src={zlockLogo} alt="" className="h-14 w-62 mb-2.5" />Z ATS-AI
