      ...
      <div className="relative max-w-4xl mx-auto">
        <div className="flex items-center justify-between">
          <button
            ...
            className="absolute left-0 z-10 transform -translate-x-12 text-gray-400 hover:text-gray-600 transition-colors"
          ...
          <div className="relative w-full h-[400px] perspective">
            <div className="absolute -right-32 -top-12 w-[550px]  h-[550px] ">
            ...
            <div className="w-full h-full relative">
              ...
              <AnimatePresence initial={false} custom={direction}>
                <motion.div
                  ...
                  className="absolute inset-0 bg-white rounded-lg shadow-2xl"
                >
                  <div className="relative h-full  p-18">
                    <div className="relative z-10">
                      ...
                      >
                        <h3 className="text-2xl text-black font-medium mb-3">
                      ...
                      <motion.p
                        ...
                        className="text-gray-600 mb-6 text-center max-w-3xl mx-auto"
                      >
          ...
          <button
            onClick={handleNext}
            className="absolute right-0 z-10 transform translate-x-12 text-gray-400 hover:text-gray-600 transition-colors"
