...
const SecondCareersSection = () => {
  ...
  return (
    <div className="bg-white py-10 px-5">
      <div className="flex px-18 gap-20   mx-auto">
        <h2 className="text-3xl text-[#005487] w-[30%]">
          Join the Zonit Team:{" "}
          <span className=""><br />Where Innovation Fuels Your Career</span>
        </h2>
        <p className="w-[50%] text-lg text-gray-600 ">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8 px-18 lg:grid-cols-3">
