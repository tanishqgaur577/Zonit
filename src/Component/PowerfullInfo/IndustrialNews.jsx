      ...
      <div className=" p-6 mt-10 h-[70vh] flex justify-center  min-w-[100vw]">
        <div className=" bg-gray-100 w-full py-8 h-max px-8 flex flex-col ">
          ...
          <div className="flex flex-col md:flex-row gap-6 h-[100px] justify-center mt-6">
            <div className="flex flex-col rounded-tr-4xl justify-start  h-[200px] w-[320px] items-center bg-white p-9 shadow-lg">
              <p className="text-xl ">
            ...
            <div className="flex flex-col rounded-tr-4xl h-[200px] w-[320px] justify-start items-center bg-white p-9 shadow-lg">
              <p className="text-xl">
                <span className="text-blue-400 cursor-pointer underline underline-thickness-thin underline-offset-2">
